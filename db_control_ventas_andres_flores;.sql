...
Catedrático: Jorge Luis Pérez Canto
	...
	Nombre alumno:	Andres Andhu Flores Hernandez
	Carné:	2021049
...
-- -----------------------------------------------------
DROP DATABASE IF EXISTS db_control_ventas_andres_flores;
CREATE DATABASE IF NOT EXISTS db_control_ventas_andres_flores;
USE db_control_ventas_andres_flores;
...
-- -------------------------------------------------------------
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_detalle_compras$$
CREATE PROCEDURE sp_detalle_compras(
	id INT,
	compra_id INT,
	producto_id INT,
	cantidad INT,
...
BEGIN
	INSERT INTO detalle_compras (id, compra_id, Producto_id, cantidad, total) 
    VALUES (_id, _compra_id, _Producto_id, _cantidad, _total);
END$$
...
BEGIN
	INSERT INTO detalle_compras (id, nombre, existencia, precio_unitario, precio_docena, precio_mayor) 
    VALUES (_id, _ombre, _existencia, _precio_unitario, _precio_docena, _precio_mayor);
END$$
DELIMITER ;
...
BEGIN
	INSERT INTO ventas (id, venta_id, producto_id, cantidad) 
    VALUES (_id, _venta_id, _producto_id, _cantidad);
END$$
DELIMITER ;
